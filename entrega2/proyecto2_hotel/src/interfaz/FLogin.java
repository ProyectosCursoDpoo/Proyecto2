...
public class FLogin extends JPanel {
    ...
    public void inicializar() {
        ...
        titulo.setFont(titulo.getFont().deriveFont(30f)); // aumenta el tamaño de la fuente
        ...
        centerPanel.setBackground(new Color(129, 133, 142));
        ...
        usuarioPanel.add(new JLabel(new ImageIcon(icon1.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
        usuarioPanel.setBackground(new Color(129, 133, 142));
        ...
        contrasenaPanel.add(new JLabel(new ImageIcon(icon2.getImage().getScaledInstance(50, 50, Image.SCALE_SMOOTH))));
        contrasenaPanel.setBackground(new Color(129, 133, 142));
        ...
        // Panel inferior con espacio vacío para alinear el botón de inicio de sesión en el centro
